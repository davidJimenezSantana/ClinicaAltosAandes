...
class visitaDAO
{
    ...
    public function consultarVisitasAgenda()
    {
        return "SELECT idvisita,estado_visita_idestado_visita, agenda_idagenda, fecha, hora, observaciones, motivo
                FROM visita
                WHERE agenda_idagenda = '" . $this->agenda_idagenda ."'";
    }
    public function agendarVisita(){
        return "INSERT INTO visita (estado_visita_idestado_visita, agenda_idagenda, fecha, hora, observaciones, motivo,historia_clinica_idhistoria_clinica)
                VALUES ('" . $this->estado_visita_idestado_visita . "', '" . $this->agenda_idagenda . "', '" . $this->fecha . "', '" . $this->hora . "','" . $this->observaciones . "','" . $this->motivo . "','" . $this->historia_clinica_idhistoria_clinica . "')";
    }
}
