...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php?pid=<?php echo base64_encode("vista/doctor/inicioDoctor.php") ?>">
            <img src="vista/img/icon/IconAltosAndes.png" alt="Bootstrap" width="40" height="34">
        </a>
        <a class="navbar-brand" href="index.php?pid=<?php echo base64_encode("vista/doctor/inicioDoctor.php") ?>"><?php echo $usuario->getRol()->getNombre() . ": " . $usuario->getNombre() . " " . $usuario->getApellido(); ?></a>
